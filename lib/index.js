...
var Time = function (_React$Component) {
  ...
  function Time() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleClick = function (time) {
      ...
      /* MODIFIED HERE - JW */
      /* Delete everything up to a comment and uncomment rest for original version */
      console.log(_this.props.injectTimes);
      console.log(sortedInjectTimes);
      console.log(sortedInjectTimes.length);
      if (false) {//_this.props.injectTimes && sortedInjectTimes && sortedInjectTimes.length > 0
